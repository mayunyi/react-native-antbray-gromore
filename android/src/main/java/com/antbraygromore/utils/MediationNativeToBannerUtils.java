//package com.antbraygromore.utils;
//
...
////            Glide.with(activity).load(ad.getImageUrl()).into(adViewHolder.mVerticalImage);
//    }
//    return convertView;
//  }
//
...
//    bindData(convertView, adViewHolder, ad, viewBinder, activity);
//    if (ad.getImageUrl() != null) {
////            Glide.with(activity).load(ad.getImageUrl()).into(adViewHolder.mLargeImage);
//    }
//    return convertView;
//  }
//
...
//    bindData(convertView, adViewHolder, ad, viewBinder, activity);
//    if (ad.getImageUrl() != null) {
////            Glide.with(activity).load(ad.getImageUrl()).into(adViewHolder.mSmallImage);
//    }
//    return convertView;
//  }
//
//  private static void bindData(View convertView, AdViewHolder adViewHolder, IMediationNativeAdInfo ad,
